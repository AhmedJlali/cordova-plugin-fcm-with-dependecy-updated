...
Since the [project](https://github.com/andrehtissot/cordova-plugin-fcm-with-dependecy-updated) has sadly been dropped after 3 years (as mentioned in the project's repo) of maintaining due to lack of sponsorship from the community, it no longer works with the latest plugin updates or at least creates some build issues for both iOS and Android applications using this plugin, like :  
